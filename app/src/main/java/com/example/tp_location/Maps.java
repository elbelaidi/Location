...
public class Maps extends FragmentActivity implements OnMapReadyCallback {
    ...
    String showUrl = "http://192.168.1.70/Localisation/showPositions.php";
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(@NonNull Marker marker) {
                LinearLayout info = new LinearLayout(Maps.this);
                info.setOrientation(LinearLayout.VERTICAL);

                TextView title = new TextView(Maps.this);
                title.setText(marker.getTitle());
                title.setTypeface(null, Typeface.BOLD);

                TextView snippet = new TextView(Maps.this);
        ...
        LocationCallback locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult locationResult) {
                for (android.location.Location location : locationResult.getLocations()) {
                    ...
                    Toast.makeText(Maps.this, "Position : " + lat + ", " + lon, Toast.LENGTH_SHORT).show();
    ...
    private void setUpMap() {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            try {
                ...
                Toast.makeText(Maps.this, "Erreur lors de la récupération des positions", Toast.LENGTH_SHORT).show();
            }
        }, error -> Toast.makeText(Maps.this, "Erreur de connexion", Toast.LENGTH_SHORT).show());
        ...
        StringRequest request = new StringRequest(Request.Method.POST, insertUrl, response -> {
            try {
                ...
                if ("success".equals(status)) {
                    Toast.makeText(Maps.this, "Position ajoutée avec succès", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Maps.this, "Erreur : " + message, Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                Log.e("MAP_DEBUG", "JSONException: ", e);
                Toast.makeText(Maps.this, "Erreur lors de la récupération de la réponse", Toast.LENGTH_SHORT).show();
            }
        }, error -> {
            Toast.makeText(Maps.this, "Erreur de connexion : " + error.getMessage(), Toast.LENGTH_SHORT).show();
